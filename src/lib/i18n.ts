...
export const copy = {
  zh: {
    ...
    signalsHint: "先扫热点版图，再展开方向、对象与依据。",
    hotspotIndex: "热点版图",
    hotspotIndexEyebrow: "Today’s news map",
    hotspotIndexHint: "全期热点按优先级与主题组织；编号与下方完整解读一致。",
    hotspotTop: "今日头条",
    hotspotTopEyebrow: "Top news",
    hotspotMacro: "政策与宏观",
    hotspotMacroEyebrow: "Policy & macro",
    hotspotCompany: "公司与财报",
    hotspotCompanyEyebrow: "Companies & earnings",
    hotspotIndustry: "行业与商品",
    hotspotIndustryEyebrow: "Sectors & commodities",
    hotspotSource: "来源",
    signalAnalysis: "影响拆解",
    signalAnalysisHint: "事实、传导机制与核验依据",
    aiRead: "AI 解读",
    impact: "影响",
  ...
  en: {
    ...
    signalsEyebrow: "Market moving news",
    signalsHint: "Scan the news map, then inspect direction, exposure and evidence.",
    hotspotIndex: "News Map",
    hotspotIndexEyebrow: "Today’s news map",
    hotspotIndexHint:
      "Stories are organized by editorial priority and theme; numbering matches the full analysis below.",
    hotspotTop: "Top News",
    hotspotTopEyebrow: "Top news",
    ...
    signalAnalysis: "Impact Analysis",
    signalAnalysisHint: "Facts, transmission and verification",
