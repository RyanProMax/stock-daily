...
export const copy = {
  zh: {
    ...
    sectorPerformance: "行业板块",
    sectorPerformanceRangeCN: "中证一级行业 · 11 类 · 每类 4 只代表标的",
    sectorPerformanceRangeUS: "GICS 行业板块 · 11 类 · 每类 4 只代表标的",
    aiChainPerformance: "AI 产业链",
    aiChainRangeCN: "统一 8 层 · 每层 4 只代表标的",
    aiChainRangeUS: "统一 8 层 · 每层 4 只代表标的",
    heatStreak: "连续大幅波动",
    heatStreakDays: "连续 {count} 个交易日",
    noHeatStreak: "暂无连续两个交易日大幅波动的板块",
    currentMarkets: "大盘指数",
    compositeAnalysis: "综合研判",
    verifiedSources: "已核验来源",
    representativeBasket: "代表标的",
    todayFocus: "今日重点",
    nextCheckpoint: "后续观察",
    keySignals: "影响今日定价的 3 条线索",
    thesisHistory: "观点验证",
    whyImportant: "为什么重要",
  ...
  en: {
    ...
    sectorPerformance: "Sector Groups",
    sectorPerformanceRangeCN: "11 CSI level-one sectors · 4 representatives each",
    sectorPerformanceRangeUS: "11 GICS sectors · 4 representatives each",
    aiChainPerformance: "AI Supply Chain",
    aiChainRangeCN: "Unified 8 layers · 4 representatives each",
    aiChainRangeUS: "Unified 8 layers · 4 representatives each",
    ...
    currentMarkets: "Market Indexes",
    compositeAnalysis: "Composite Read",
    verifiedSources: "Verified sources",
    representativeBasket: "Representatives",
    todayFocus: "Today's Focus",
    nextCheckpoint: "What to Watch",
    keySignals: "Three Signals Shaping Today's Pricing",
    thesisHistory: "Thesis Verification",
    ...
    impactPath: "Open full analysis",
    exposure: "Exposures",
    checkpoint: "What to Watch",
    confirmIf: "Confirmation",
    invalidateIf: "Invalidation",
    verifyBy: "Watch through",
    confidence: "Confidence",
    impactWindow: "Pricing window",
    coreSignal: "Core",
